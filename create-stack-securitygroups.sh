...
aws cloudformation create-stack --capabilities CAPABILITY_IAM --stack-name $STACK_PREFIX-sg --template-body file://cloudformation/securitygroups.yaml --parameters \
